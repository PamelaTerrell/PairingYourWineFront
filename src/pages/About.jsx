  ...
  return (
    <div className="about-container">
      ...
      <p>
        ...
        Of course, there's more to making successful wine-and-food pairings. The key to finding the perfect match is to balance the flavors, textures, and aromas of both the food and the vino.
      </p>
      <p>
